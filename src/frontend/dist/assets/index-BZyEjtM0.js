...
function GameOverModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay", "data-ocid": "gameover.modal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "modal-card",
      style: {
        background: "linear-gradient(160deg, #1a0a2e 0%, #3B0A5C 60%, #7A2DE2 100%)",
        border: "2px solid rgba(255,255,255,0.1)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 56, marginBottom: 8 }, children: "😢" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Out of moves! Better luck next time 🍬"
          }
        ),
        isNewHigh && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              background: "linear-gradient(135deg, rgba(246,211,107,0.2), rgba(240,90,168,0.2))",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 1, background: "rgba(255,255,255,0.1)" } }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
...
function findMatches(board) {
  ...
  for (let col = 0; col < BOARD_SIZE; col++) {
    for (let row = 0; row < BOARD_SIZE - 2; row++) {
      ...
      const c = board[i];
      if (c < 0) continue;
      if (board[(row + 1) * BOARD_SIZE + col] === c && board[(row + 2) * BOARD_SIZE + col] === c) {
        let end = row + 2;
        while (end + 1 < BOARD_SIZE && board[(end + 1) * BOARD_SIZE + col] === c)
          end++;
...
function calcScore(matchSet, chain) {
  ...
  for (let col = 0; col < BOARD_SIZE; col++) {
    ...
    for (let row = BOARD_SIZE - 1; row >= 0; row--) {
      if (newBoard[row * BOARD_SIZE + col] !== -1) {
        newBoard[writeRow * BOARD_SIZE + col] = newBoard[row * BOARD_SIZE + col];
...
function refillBoard(board) {
  const newBoard = [...board];
  const newIndices = /* @__PURE__ */ new Set();
...
function useGameEngine(level, initialScore, onLevelComplete, onGameOver) {
  const targetScore = getTargetScore(level);
  const [board, setBoard] = reactExports.useState(() => createBoardNoMatches());
  const [selected, setSelected] = reactExports.useState(null);
  const [exploding, setExploding] = reactExports.useState(/* @__PURE__ */ new Set());
  const [newCandies, setNewCandies] = reactExports.useState(/* @__PURE__ */ new Set());
  const [invalidCells, setInvalidCells] = reactExports.useState(/* @__PURE__ */ new Set());
  const [score, setScore] = reactExports.useState(initialScore);
  const [moves, setMoves] = reactExports.useState(MOVES_PER_LEVEL);
  ...
  const processChain = reactExports.useCallback(
    async (startBoard, startScore) => {
      ...
      while (true) {
        ...
        await delay(380);
        setNewCandies(/* @__PURE__ */ new Set());
        chain++;
      }
  ...
  const handleTap = reactExports.useCallback(
    (index2) => {
      ...
      const swapped = swapCells(currentBoard, sel, index2);
      const matches = findMatches(swapped);
      if (matches.size === 0) {
        setInvalidCells(/* @__PURE__ */ new Set([sel, index2]));
        setTimeout(() => setInvalidCells(/* @__PURE__ */ new Set()), 350);
        return;
      }
  ...
  const resetBoard = reactExports.useCallback(() => {
...
function CandyTile({
  ...
  if (type < 0) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { aspectRatio: "1/1" } });
  ...
  const handleInteract = () => onTap(index2);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      style: {
        ...
        border: isSelected ? "2.5px solid rgba(255,255,255,0.95)" : "1.5px solid rgba(255,255,255,0.15)",
        padding: 0
      },
      ...
      "data-ocid": `board.item.${index2 % 8 + 1}`,
...
function GameBoard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: board.map((type, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CandyTile,
        {
          index: i,
          type,
...
const HEART_KEYS$1 = ["h0", "h1", "h2", "h3", "h4"];
function GameHUD({
  score,
  targetScore,
  level,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: S.label, children: "Level" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: S.label, children: "Score" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: S.label, children: "Moves" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: S.label, children: "Lives" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14, lineHeight: 1.4 }, children: HEART_KEYS$1.map((k, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { opacity: i < lives ? 1 : 0.25 }, children: "❤️" }, k)) })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "score-progress", style: { height: 8 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        ...
        background: "linear-gradient(180deg, #1a0a2e 0%, #2D1B5E 40%, #4A0E7A 100%)",
        maxWidth: 480,
        margin: "0 auto"
      },
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: isAnimating ? "✨ Matching..." : selected !== null ? "Tap an adjacent candy to swap!" : "Tap a candy to select"
                }
              )
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "0 1rem 1.5rem", textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            style: {
...
function MiniCandy({ type, size = 36 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function HomeScreen({ onPlay, highScore }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        ...
        display: "flex",
        flexDirection: "column",
        background: "linear-gradient(180deg, #1a0a2e 0%, #2D1B5E 35%, #5C1A8A 65%, #9A2EC0 100%)",
        maxWidth: 480,
        margin: "0 auto",
        overflow: "hidden"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "Sweet Match-3 Adventure"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: PREVIEW_BOARD.map((t, i) => (
                    // biome-ignore lint/suspicious/noArrayIndexKey: static decorative board
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MiniCandy, { type: t, size: 34 }, i)
                  ))
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 22, marginBottom: 4 }, children: HEART_KEYS.map((k, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    boxShadow: "0 6px 28px rgba(246,211,107,0.55), 0 2px 0 rgba(0,0,0,0.2)"
                  },
                  onClick: onPlay,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: HOW_TO.map(({ icon, text }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { style: { padding: "1rem", textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "p",
          {
            style: {
...
function LevelCompleteModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay", "data-ocid": "levelcomplete.modal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "modal-card",
      style: {
        background: "linear-gradient(160deg, #2D1B5E 0%, #4A1280 60%, #7A2DE2 100%)",
...
function loadHighScore() {
  try {
    return Number.parseInt(localStorage.getItem("candyCrushHighScore") || "0", 10) || 0;
  } catch {
    return 0;
  }
}
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100dvh", background: "#1a0a2e" }, children: [
    screen === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx(HomeScreen, { onPlay: startGame, highScore: gameState.highScore }),
    screen === "playing" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      GameScreen,
      {
    ...
    screen === "levelComplete" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      LevelCompleteModal,
      {
    ...
    screen === "gameOver" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      GameOverModal,
      {
        score: gameState.score,
...
Service({
  ...
  "confirmPurchase": Func([Text], [], []),
  "createCheckoutSession": Func(
    [Vec(ShoppingItem), Text, Text],
    [Text],
    []
  ),
  "getAllTracks": Func([], [Vec(Track)], ["query"]),
  "getAudioFile": Func([Text], [ExternalBlob], []),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getPurchasedTracks": Func([Principal2], [Vec(Track)], ["query"]),
  "getStripeSessionStatus": Func([Text], [StripeSessionStatus], []),
  "getTrackMetadata": Func([Text], [Track], ["query"]),
  "getTracksByGenre": Func([Text], [Vec(Track)], ["query"]),
  ...
  "uploadTrack": Func(
    [Text, Text, Nat, Text, ExternalBlob],
    [Text],
    []
  )
});
