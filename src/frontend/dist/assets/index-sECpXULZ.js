...
function GameOverModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay", "data-ocid": "gameover.modal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "linear-gradient(160deg, #fff2f8 0%, #fde0f0 50%, #f0d8ff 100%)",
        border: "2px solid rgba(255,255,255,0.8)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 56, marginBottom: 10 }, children: "😢" }),
        ...
        isNewHigh && /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            style: {
              background: "linear-gradient(135deg, rgba(255,212,50,0.25), rgba(255,79,163,0.2))",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 1, background: "rgba(163,92,255,0.2)" } }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
...
function useGameEngine(level, initialScore, onLevelComplete, onGameOver) {
  ...
  const boardRef = reactExports.useRef(board);
  const scoreRef = reactExports.useRef(initialScore);
  const movesRef = reactExports.useRef(MOVES_PER_LEVEL);
  ...
  const executeSwap = reactExports.useCallback(
    (sel, target) => {
      ...
      if (matches.size === 0) {
        setInvalidCells(/* @__PURE__ */ new Set([sel, target]));
  ...
  const handleTap = reactExports.useCallback(
    (index2) => {
      ...
      executeSwap(sel, index2);
    },
    [executeSwap]
  );
  const handleSwipe = reactExports.useCallback(
    (fromIndex, toIndex) => {
      if (animatingRef.current) return;
      selectedRef.current = null;
      setSelected(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      style: {
        ...
        border: isSelected ? "2.5px solid rgba(255,255,255,0.95)" : "1.5px solid rgba(255,255,255,0.25)",
        padding: 0,
        display: "flex",
        alignItems: "center",
        justifyContent: "center"
      },
      onClick: () => onTap(index2),
...
function GameBoard({
  ...
  const touchStartRef = reactExports.useRef(
    null
  );
  const boardRef = reactExports.useRef(null);
  const handleTouchStart = (e, index2) => {
    e.preventDefault();
    const touch = e.touches[0];
    touchStartRef.current = { x: touch.clientX, y: touch.clientY, index: index2 };
  };
...
function GameHUD({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", marginBottom: 8 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: "candy-title",
            style: { fontSize: "clamp(18px,5vw,26px)", display: "inline-block" },
            children: "Candy Crush"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                {
                  style: {
                    background: movesLow ? "linear-gradient(135deg,#FF5722,#E53935)" : "linear-gradient(135deg,#2E86FF,#A35CFF)",
                    borderRadius: 12,
                    padding: "5px 12px",
                    textAlign: "center",
                    minWidth: 52,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14, lineHeight: 1, letterSpacing: 1 }, children: HEART_KEYS.map((k, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { opacity: i < lives ? 1 : 0.22 }, children: "❤️" }, k)) })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "score-progress", style: { height: 9 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: isAnimating ? "✨ Matching..." : selected !== null ? "👉 Swipe or tap adjacent candy!" : "👆 Tap or swipe a candy"
                }
              )
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "0 1.5rem 1.5rem", textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            className: "btn-ghost",
...
function HomeScreen({ onPlay, highScore }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        FLOAT_CANDIES.map(({ type, delay: delay2, left, top }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      ...
                      borderRadius: 24,
                      padding: "16px 28px",
                      boxShadow: "0 8px 32px rgba(163,92,255,0.2), 0 1px 0 rgba(255,255,255,0.8) inset",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: PREVIEW_BOARD.map((t, i) => (
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MiniCandy, { type: t, size: 32 }, i)
                  ))
                }
              ),
...
function LevelCompleteModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay", "data-ocid": "levelcomplete.modal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "modal-card",
      style: {
        background: "linear-gradient(160deg, #fff5ff 0%, #fce4ff 50%, #e8d5ff 100%)",
        border: "2px solid rgba(255,255,255,0.8)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
